...
def btn(text: str, cbd: str = None, url: str = None,
    ...
    Automatically strips HTML/tg-emoji tags from button text since
    Telegram does NOT render HTML in button labels.
    The 'style' param is accepted for API compatibility but NOT sent to
    Telegram (it causes Document_invalid errors with PTB 22).
    """
    ...
    # NOTE: style= intentionally NOT added to dict — Telegram rejects unknown fields
    return b
